...
//  RewireStroke
//
//  Created by Amy Ha on 06/02/2021.
...
struct RingView: View {
    ...
    var body: some View {
        ...
        return ZStack {
            RingBackgroundShape(thickness: thickness, radius: radius)
                .fill(backgroundColor)
            RingShape(currentPercentage: currentPercentage, thickness: thickness, radius: radius)
                .fill(gradient)
            ...
            RingTipShape(currentPercentage: currentPercentage, thickness: thickness, radius: radius)
...
struct RingShape: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        path.addArc(
            ...
            radius: radius, //rect.width / 2 - thickness,
...
struct RingTipShape: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        let controlRadius: CGFloat = radius //rect.width / 2 - thickness
